...
| L-070 | A clean-machine-style startup and full acceptance run produce one reviewable local release result | [Phase 7 consolidated acceptance evidence](../release-evidence/local-mvp-phase-7-acceptance.md) | `PASSED` |
