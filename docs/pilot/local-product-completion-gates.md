...
| LPC-080 | Phase 8 — guided local experience | Direct dashboard entry remains; a dismissible orientation, stored-evidence explainability timeline, safe retry demonstration, and coherent Local tools navigation connect the product without fabricating financial facts | First-use/demo and empty-state journeys, partial timeline fixtures, same-key retry proof, navigation/context and responsive/keyboard results | `READY` | LPC-060 and LPC-070 passed; Phase 8 may proceed |
