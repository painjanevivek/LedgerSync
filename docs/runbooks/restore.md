...
6. Run migration compatibility plus lifecycle/recovery tests against the restore. Confirm migration 000010 tables, append-only triggers, stable history indexes, dry-run retention, and inspect-only recovery work without executing a production replay.
