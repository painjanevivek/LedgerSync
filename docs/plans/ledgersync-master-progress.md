...
| M08 | Operator-console IA | `PARTIAL` | M03, M05–M07 | Product/operations | Overview, accounts, funding, transfers, corrections, reconciliation, events, recovery, developer, local status, related-record links, and bounded exports | Make navigation role/environment-aware; add approval, webhook, and authorized administration workspaces; standardize search, filters, sort, result counts, URL state, evidence, and exports. |
