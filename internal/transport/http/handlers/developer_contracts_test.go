...
func TestDeveloperContractsReturnCanonicalEmbeddedBytesWithoutCredentials(t *testing.T) {
	...
	for _, testCase := range []struct {
		...
		{path: "/api/openapi.yaml", contentType: "application/yaml; charset=utf-8", disposition: `attachment; filename="ledgersync-openapi-1.9.0.yaml"`, want: contractassets.OpenAPIYAML()},
	} {
