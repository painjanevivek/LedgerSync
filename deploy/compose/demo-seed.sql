...
BEGIN
  IF EXISTS (
    ...
    WHERE tenant_id='00000000-0000-4000-8000-000000000001' AND currency<>'INR'
  ) THEN
    RAISE EXCEPTION 'local demo contains pre-INR financial evidence; recreate the disposable local volume instead of rewriting posted history';
  END IF;
END;
$$;
...
VALUES ('00000000-0000-4000-8000-000000000001','INR',100,10000000,50000000,50000000,500000000)
...
INSERT INTO accounts (id, tenant_id, currency, status, display_name, category, external_reference, created_at) VALUES
  ('10000000-0000-4000-8000-000000000001','00000000-0000-4000-8000-000000000001','INR','active','Operating Reserve','operating','OPS-RESERVE','2026-08-20T09:00:00Z'),
  ('10000000-0000-4000-8000-000000000002','00000000-0000-4000-8000-000000000001','INR','active','Customer Funds','customer_funds','CUSTOMER-FUNDS','2026-08-20T09:01:00Z'),
  ('10000000-0000-4000-8000-000000000003','00000000-0000-4000-8000-000000000001','INR','active','Payroll','payroll','PAYROLL-IN','2026-08-20T09:02:00Z'),
  ('10000000-0000-4000-8000-000000000004','00000000-0000-4000-8000-000000000001','INR','active','Vendor Payables','payables','VENDOR-PAYABLES','2026-08-20T09:03:00Z'),
  ('10000000-0000-4000-8000-000000000005','00000000-0000-4000-8000-000000000001','INR','frozen','Marketing Expenses — India','expenses','MKTG-INDIA','2026-08-20T09:04:00Z'),
  ('10000000-0000-4000-8000-000000000006','00000000-0000-4000-8000-000000000001','INR','active','New Project · No activity','reserve','PROJECT-EMPTY','2026-08-20T09:05:00Z')
...
INSERT INTO account_opening_balances (account_id, opening_ledger_minor) VALUES
 ('10000000-0000-4000-8000-000000000001',140756419),('10000000-0000-4000-8000-000000000002',86700000),
 ('10000000-0000-4000-8000-000000000003',21600000),('10000000-0000-4000-8000-000000000004',11250000),
...
INSERT INTO ledger_postings (id,journal_transaction_id,account_id,direction,amount_minor,currency,occurred_at) VALUES
 ('40000000-0000-4000-8000-000000000001','30000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001','debit',1250000,'INR','2026-08-20T11:58:34Z'),
 ('40000000-0000-4000-8000-000000000002','30000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000004','credit',1250000,'INR','2026-08-20T11:58:34Z'),
 ('40000000-0000-4000-8000-000000000003','30000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000002','debit',2500000,'INR','2026-08-20T11:47:12Z'),
 ('40000000-0000-4000-8000-000000000004','30000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000001','credit',2500000,'INR','2026-08-20T11:47:12Z') ON CONFLICT (id) DO NOTHING;
...
INSERT INTO reconciliation_runs (id,tenant_id,status,checked_account_count,mismatch_count,correlation_id,started_at,completed_at,details) VALUES
 ('50000000-0000-4000-8000-000000000001','00000000-0000-4000-8000-000000000001','matched',6,0,'60000000-0000-4000-8000-000000000001','2026-08-20T11:59:58Z','2026-08-20T12:00:00Z','{"posting_count":4,"ledger_watermark":"8241197","application_version":"demo-1","scope":"All INR demo accounts"}'),
 ('50000000-0000-4000-8000-000000000002','00000000-0000-4000-8000-000000000001','mismatch',6,1,'60000000-0000-4000-8000-000000000002','2026-08-20T10:39:58Z','2026-08-20T10:40:02Z','{"posting_count":4,"ledger_watermark":"8241196","application_version":"demo-1","scope":"All INR demo accounts","note":"Controlled historical mismatch fixture"}')
ON CONFLICT (id) DO NOTHING;
COMMIT;
