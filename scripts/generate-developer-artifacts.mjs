...
function typeScriptClient(version, sourceHash, operations) {
  ...
  return `${generatedHeader(sourceHash)}export const apiVersion = ${JSON.stringify(version)} as const;
...
function goClient(version, sourceHash, operations) {
  ...
  return `${generatedHeader(sourceHash)}package ledgersync
