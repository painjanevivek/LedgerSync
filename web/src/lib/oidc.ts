...
const allowedScopes = new Set(["accounts:read", "accounts:write", "transfers:read", "transfers:write", "transactions:read", "reconciliation:read", "reconciliation:write", "audit:read", "local:read", "local:write", "events:read", "explainability:read", "developer:read", "recovery:read", "exports:read"]);
