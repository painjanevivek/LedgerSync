...
const allowedScopes = new Set(["accounts:read", "accounts:write", "transfers:read", "transfers:write", "transactions:read", "reconciliation:read", "reconciliation:write", "audit:read", "local:read", "events:read"]);
