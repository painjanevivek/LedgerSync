...
const endpointGroupIDs = new Set(["accounts", "transfers", "corrections", "funding", "reconciliation", "operations", "recovery_exports", "developer"]);
const scopes = new Set(["accounts:read", "accounts:write", "transactions:read", "transfers:read", "transfers:write", "corrections:read", "corrections:write", "corrections:approve", "funding:read", "funding:write", "funding:approve", "reconciliation:read", "reconciliation:write", "local:read", "local:write", "events:read", "explainability:read", "developer:read", "recovery:read", "exports:read"]);
