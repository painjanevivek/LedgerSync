...
export const transfer = { transfer_id:"33333333-3333-4333-8333-333333333333",source_account_id:sourceAccount.account_id,destination_account_id:destinationAccount.account_id,amount_minor:"500",currency:"USD",financial_status:"posted",delivery_status:"delayed",created_at:"2026-08-19T11:00:00Z",completed_at:"2026-08-19T11:00:01Z",journal_transaction_id:"44444444-4444-4444-8444-444444444444" };
export const run = { run_id:"55555555-5555-4555-8555-555555555555",status:"matched",correlation_id:"66666666-6666-4666-8666-666666666666",scope:"All authorized USD accounts",ledger_watermark:"8",application_version:"test",checked_account_count:2,posting_count:2,mismatch_count:0,started_at:"2026-08-19T11:59:58Z",completed_at:"2026-08-19T12:00:00Z" };
