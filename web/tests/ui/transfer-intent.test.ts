...
test("a stored retry key is bound to the complete canonical transfer intent", () => {
  const intent = createStoredTransferIntent("12345678-1234-4234-8234-123456789012", "12345678-1234-4234-8234-123456789013", prepared);
...
test("stored intent parsing fails closed for corrupt or ambiguous financial input", () => {
  const valid = createStoredTransferIntent("12345678-1234-4234-8234-123456789012", "12345678-1234-4234-8234-123456789013", prepared);
