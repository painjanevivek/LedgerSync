...
func TestProvisionedDatabaseRolesHaveNoForbiddenStandingAuthority(t *testing.T) {
	...
	checks := []struct {
		...
		{"ledgersync_api", "funding_events", "INSERT", false},
		{"ledgersync_api", "funding_events", "UPDATE", false},
		{"ledgersync_api", "funding_events", "DELETE", false},
		{"ledgersync_api", "approval_records", "SELECT", true},
		{"ledgersync_api", "approval_records", "INSERT", false},
		{"ledgersync_api", "approval_records", "UPDATE", false},
		{"ledgersync_api", "transfer_corrections", "SELECT", true},
		{"ledgersync_api", "transfer_corrections", "INSERT", false},
		{"ledgersync_api", "transfer_corrections", "UPDATE", false},
		{"ledgersync_api", "funding_velocity_events", "INSERT", false},
