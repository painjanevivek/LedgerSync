...
-- This migration is also valid for the retained pre-command-schema snapshot
-- used by the forward-upgrade test. The transfer aggregate invariant is added
-- by 000023 after every command-schema migration has been applied.
